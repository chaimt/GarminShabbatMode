---
name: speckit-spec-constitution
...
metadata:
  ...
  source: agentic-sdlc:commands/adlc.spec.constitution.md
user-invocable: true
...
1. **Run setup script** to load team directives and project context:
   - Execute: `.specify/scripts/bash/setup-constitution.sh` from repository root
