...
3. **Execute plan workflow** (CREATE ALL ARTIFACTS):
   ...
   - **Phase 1: RUN agent context update** - Execute `.specify/scripts/bash/update-agent-context.sh claude` to update agent-specific files
