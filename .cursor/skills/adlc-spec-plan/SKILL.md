...
metadata:
  ...
  source: agentic-sdlc:commands/adlc.spec.plan.md
---
...
3. **Execute plan workflow** (CREATE ALL ARTIFACTS):
   ...
   - **Phase 1: RUN agent context update** - Execute `.specify/scripts/bash/update-agent-context.sh cursor-agent` to update agent-specific files
