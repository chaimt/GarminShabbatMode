...
validation_script:
    sh: .specify/scripts/bash/validate-trace.sh --json
    ps: .specify/scripts/powershell/validate-trace.ps1 -Json
---
...
1. **Execute trace generation script**: `.specify/scripts/bash/generate-trace.sh --json`
